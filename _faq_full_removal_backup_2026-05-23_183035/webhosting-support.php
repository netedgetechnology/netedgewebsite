<?php
$title = 'Webhosting Support | Netedge Technology';
$description = 'Webhosting Support services from Netedge Technology, designed for stable, secure and scalable technology operations.';
?>
<section class="page-hero v11-page-hero sm58-page-hero batch68-page-hero">
  <div class="container sm58-hero-grid batch68-hero-grid">
    <div class="sm58-hero-copy">
      <span class="d3-kicker">Webhosting Support</span>
      <h1>Webhosting Support</h1>
      <p>Webhosting Support services from Netedge Technology, designed for stable, secure and scalable technology operations.</p>
      <div class="sm58-hero-pills"><span>cPanel/WHM,</span><span>Customer</span><span>Website,</span><span>Migration,</span></div>
    </div>
...
<section class="section">
  <div class="container content-page v48-static-page server-management-content server-management-v56 batch68-page" data-cms-slug="webhosting-support">
    ...
    <section class="sm56-benefits"><div class="sm56-section-title"><span class="section-label">Service coverage</span><h2>Webhosting Support Services</h2></div><div class="sm56-check-grid"><div><span>✓</span>cPanel/WHM, Plesk and DirectAdmin support</div>
...
<div><span>✓</span>24x7 hosting operations support</div></div></section>
    <section class="sm56-expertise"><div class="sm56-section-title center"><span class="section-label">Expertise</span><h2>Our Webhosting Support Expertise</h2><p>Professional service coverage designed around your business requirement and operational goals.</p></div><div class="sm56-card-grid batch68-card-grid"><article class="sm56-expert-card batch68-card">
          ...
          <h3>cPanel/WHM, Plesk</h3>
          <p>cPanel/WHM, Plesk and DirectAdmin support with professional planning, execution and ongoing support.</p>
...
<article class="sm56-expert-card batch68-card">
    ...
    <section class="content-cta-block"><div><h2>Need webhosting support support?</h2><p>Share your requirement and our team will review the right support model for your business.</p></div><a class="btn" href="<?= e(url('discuss-a-requirement')) ?>">Discuss A Requirement</a></section>
  </div>
</section>