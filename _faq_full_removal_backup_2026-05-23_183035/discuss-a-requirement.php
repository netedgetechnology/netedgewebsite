<section class="page-hero v11-page-hero">
  <div class="container v11-page-hero-grid">
    <div>
      <span class="d3-kicker">Discuss A Requirement</span>
    ...
    <div class="v11-hero-panel">
      <strong>Requirement Discussion</strong>
      <ul>
...
<section class="section v11-contact-section">
  <div class="container v11-contact-grid">
    <div class="v11-contact-card">
      ...
      <p>Use this form to discuss your IT support, managed services, cloud infrastructure, software development or staffing requirement.</p>
      ...
      <form class="form v11-form" method="post" action="<?= e(url('discuss-a-requirement/submit')) ?>">
        ...
        <button class="btn" type="submit">Submit Requirement</button>
      </form>
    </div>
