...
if ( ! function_exists( 'elementor_pro_render_mini_cart_item' ) ) {
	function elementor_pro_render_mini_cart_item( $cart_item_key, $cart_item ) {
		...
		<div class="elementor-menu-cart__product woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
			...
			<div class="elementor-menu-cart__product-name product-name" data-title="<?php esc_attr_e( 'Product', 'vamtam-elementor-integration' ); ?>">
				<?php
				if ( ! $product_permalink ) :
			...
			<div class="elementor-menu-cart__product-price product-price" data-title="<?php esc_attr_e( 'Price', 'vamtam-elementor-integration' ); ?>">
			...
			<div class="elementor-menu-cart__product-remove product-remove">
				...
				echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf(
					...
					__( 'Remove this item', 'vamtam-elementor-integration' ),
					esc_attr( $product_id ),
...
if ( empty( $cart_items ) ) { ?>
	<div class="woocommerce-mini-cart__empty-message"><?php esc_attr_e( 'No products in the cart.', 'vamtam-elementor-integration' ); ?></div>
<?php } else { ?>
