...
class VamtamFramework {
	...
	public static function theme_supports() {
		...
		add_theme_support( 'vamtam-post-thumb-shape' );
		...
		function vamtam_elementor_widgets_support( bool $supports, array $args, string $feature ) {
			...
			$supported_features = [
				'icon-box--amorph-shape',
				'icon-box--box-is-link',
				'image-box--subtitle-field',
				'image-box--masks-and-eye',
				'image-box--box-is-link',
				'nav-menu--individual-nav-items',
				'nav-menu--circle-pointer',
				'nav-menu--line-through-pointer',
				'posts--thumb-shape',
				'tabs--title-numbering',
				'social-icons--custom-layout',
				'slides--force-slide-stretch',
				'slides--force-contain-slide',
				'nav-menu--pointer-anim-bounce',
		...
		if ( function_exists( 'register_nav_menus' ) ) {
			register_nav_menus(
				array(
					'primary-menu'     => esc_html__( 'Menu Header', 'skole' ),
				)
			);
		}
	}
	...
	public static function load_languages() {
		load_theme_textdomain( 'skole', VAMTAM_THEME_DIR . 'languages' );
	}
	...
	public static function license_valid() {
		...
		esc_html_e( 'Valid Purchase Key.', 'skole' );
		echo '<p>';
		esc_html_e( 'Congratulations! You have succesfully registered your product.', 'skole' );
		echo '</p>';
		echo '</span>';
	}
	...
	public static function license_invalid() {
		echo '<span id="fail">';
		esc_html_e( 'Incorrect Purchase Key.', 'skole' );
		echo '<p>';
		esc_html_e( 'Please check your purchase code and re-enter.', 'skole' );
		echo '</p>';
		echo '</span>';
	}
	...
	public static function license_failed() {
		...
		esc_html_e( 'Cannot validate Purchase Key. Please try again later. If the problem persists your server might not have the curl PHP extension enabled.', 'skole' );
		echo '</span>';
	}
				...
				<div class="vamtam-notice vamtam-license-notice notice">
					...
					<div class="vamtam-notice-content">
						...
						<?php if ( $is_token ) : ?>
							...
							<?php
								echo wp_kses( sprintf( __( ' <a href="%s" target="_blank"> this link</a>', 'skole' ), esc_url( 'https://api.extensions.envato.com/extensions/begin_activation'
	...
	public static function token_unregistered() {
		echo '<span id="success">';
		esc_html_e('Unregistered Token.', 'skole');
		echo '</span>';
	}

	public static function token_unregister_fail() {
		echo '<span id="fail">';
		esc_html_e('Failed to unregister token. Please try again later. If this issue persists please contact support.', 'skole');
		echo '</span>';
	}

	public static function license_unregister() {
		echo '<span id="success">';
		esc_html_e( 'Unregistered Key.', 'skole' );
		echo '</span>';
	}
