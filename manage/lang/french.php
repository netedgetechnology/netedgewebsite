...
$_LANG['clientareacontactsemailssupport'] = "Courriels des demandes d'assistance : recevez une copie de toutes les communications liées aux demandes d'assistance créés par le titulaire du compte parent.";
...
$_LANG['clientareaerrorpasswordnotmatch'] = "Les mots de passe saisis ne correspond pas.";
...
$_LANG['domainregisterns'] = "Enregistrer un serveur de noms";
...
$_LANG['flashtutorialsheadertext'] = "Nos tutoriels Flash vous aideront optimiser l'utilisation de votre panneau de contrôle. Sélectionnez une tâche ci-dessous pour suivre les étapes d'optimisation pas-à-pas.";
...
$_LANG['maxmind_rejectemail'] = "Nous n'acceptons pas les commandes utilisant une adresse e-mail gratuite. Veuillez utilier une autre adresse.";
...
$_LANG['orderForm']['domainPriceTransferLabel'] = "Transférez votre domaine chez nous et prolongez d'un an* :";
...
$_LANG['orderForm']['removePromotionCode'] = "Rtetirer le code promo";
...
$_LANG['orderregisterdomain'] = "Enregistrer un nouveau domaine";
...
$_LANG['ox']['emailAddress'] = "Adresse courriel";
...
$_LANG['recaptcha-invalid-site-private-key'] = "Une erreur s'est produite, veuillez contactez l'assistance (code d'erreur : cap1).";
...
$_LANG['remoteAuthn']['titleLinkedAccounts'] = "Compte associé";
...
$_LANG['serverchangepasswordupdate'] = "Mettre à jour";
...
$_LANG['store']['emailServices']['benefits']['incoming']['1'] = "Protection complète de la boîte de réception à des tarif compétitifs";
...
$_LANG['store']['emailServices']['faqs']['a1'] = "Les e-mails sont acheminés via des serveurs d'auto-apprentissage intelligents SpamExperts qui détectent et bloquent le spam avant qu'il n'atteigne votre boîte de réception.";
...
$_LANG['store']['ox']['faq5']['answer'] = "Oui ! OX App Suite utilise une technologie propriétaire ainsi que des partenariats avec des fournisseurs bien établis dans le secteur de l'antispam pour préserver au mieux la sécurité de votre boîte de réception et vous éparger les pourriels.";
$_LANG['store']['ox']['faq5']['question'] = "L'applicationOX App Suite protège-t-elle contre le spam et les virus ?";
...
$_LANG['store']['ssl']['landingPage']['help']['dv']['type'] = "Un certificat de validation de domaine (DV), c'est un peut comme obtenir une carte de bibliothèque : très peu de formalités, aucune confirmation approfondie de votre identité et une émission en quelques minutes.";
...
$_LANG['subaccountpermsorders'] = "Passer de nouvelles commandes/mises à niveaux/annulations";
...
$_LANG['supportticketsticketcreateddesc'] = "Votre demande de support bien été créée. Un courriel avec les détails de votre demande vous a été expédié. Si vous désirez consulter votre demande, vous pouvez le faire dès à présent.";
...
$_LANG['ticketfeedbackforticket'] = "pour le ticket n° ";
...
$_LANG['validation']['email'] = ":attribute doit être une adresse courriel valide.";
