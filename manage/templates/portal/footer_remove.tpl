...
{/if}
  ...
  <div class="footer_resize">
    <div class="bo1">
      ...
      <h2 style="padding-left:28px;">Services</h2>
      
      <ul>      
       <li><a href="server_management.html"> Monthly Server Management</a></li>
       <li><a href="controlpanel_server_management.html">  Controlpanel Server Management</a></li>
       <li><a href="technical_support.html">Hourly Technical Support</a></li>
       <li><a href="desktop_support.html">Desktop Management</a> </li>
       <li><a href="remote_infrastructure_management.html">Infrastructure Management </a> </li>
       <li><a href="dedicated_support.html">Dedicated Support</a> </li>
       <li><a href="webhosting_support.html">Offshore Webhosting Support</a></li>   
       <li><a href="onetimeserver.html">Onetime Server Setup</a></li>
       <li> <a href="server_migration.html">Server Migration</a>  </li>
       <li><a href="server_security.html">Server security</a>  </li>
...
<p>&nbsp;</p>
    ...
    <div class="bo1">
      <h2 style="padding-left:28px;"> About     </h2>
      <ul>
    ...
    <div class="bo1">
      <h2 style="padding-left:28px;">General</h2>
      <ul>
