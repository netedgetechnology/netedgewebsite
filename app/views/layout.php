        ...
        <div class="design3-mega v20-mega">
          <div class="v20-mega-grid">
            <div class="v20-mega-col">
              <h4><span class="v20-head-icon infra"></span>INFRASTRUCTURE</h4>
              <a href="<?= e(url('server-management')) ?>">Server Management</a>
              <a href="<?= e(url('aws-infrastructure-management')) ?>">AWS Infrastructure Management</a>
            ...
            <div class="v20-mega-col">
              <h4><span class="v20-head-icon server"></span>SERVER SECURITY & MANAGEMENT</h4>
              ...
              <a href="<?= e(url('linux-server-management')) ?>">Linux Server Management</a>
              <a href="<?= e(url('windows-server-management')) ?>">Windows Server Management</a>
            ...
            <div class="v20-mega-col">
              <h4><span class="v20-head-icon software"></span>DEVELOPMENT</h4>
            ...
            <div class="v20-mega-col">
              <h4><span class="v20-head-icon staffing"></span>STAFFING</h4>
...
<div class="container v11-footer-grid">
  <div class="v11-footer-brand">
    ...
    <p>
      Netedge Technology provides infrastructure management, cloud services,
      technical support, security services, software development and technical
      staffing solutions for organizations worldwide.
    </p>
  ...
  <div>
    ...
    <a href="<?= e(url('s-e-o')) ?>">SEO Services</a>
    <a href="<?= e(url('it-infrastructure-automation')) ?>">IT Infrastructure Automation</a>
    <a href="<?= e(url('control-panel-security')) ?>">Control Panel Security</a>
    <a href="<?= e(url('vps-server-management')) ?>">VPS Server Management</a>
    <a href="<?= e(url('windows-server-management')) ?>">Windows Server Management</a>
  </div>
...
<img src="<?= e(asset('images/payments/visa.png')) ?>" alt="Visa">
<img src="<?= e(asset('images/payments/mastercard.svg')) ?>" alt="Mastercard">
<img src="<?= e(asset('images/payments/paypal.svg')) ?>" alt="PayPal">
</span>
</div>
</footer>
...
s1.async=true;
s1.src='https://embed.tawk.to/56a0bc841421893c67c2e8ce/1cp3t19dd';
s1.charset='UTF-8';
