...
$description = 'Virtualization Management services from Netedge Technology, designed for stable, secure and scalable technology operations.';
?>
<section class="page-hero v11-page-hero sm58-page-hero batch68-page-hero">
  <div class="container sm58-hero-grid batch68-hero-grid">
    <div class="sm58-hero-copy">
      ...
      <h1>Virtualization Management</h1>
      <p>Virtualization Management services from Netedge Technology, designed for stable, secure and scalable technology operations.</p>
      <div class="sm58-hero-pills"><span>VMware/Hyper-V,</span><span>Customer</span><span>Website,</span><span>Migration,</span></div>
    </div>
...
<section class="section">
  <div class="container content-page v48-static-page server-management-content server-management-v56 batch68-page" data-cms-slug="virtualization-support">
    <section class="sm56-top batch68-top">
      <div class="sm56-top-copy"><span class="section-label">Virtualization Management</span><h2>Virtualization Management</h2><p>Virtualization Management services from Netedge Technology, designed for stable, secure and scalable technology operations.</p><p>Netedge Technology provides process-driven services with a focus on stability, security, scalability and long-term operational support. This static page is structured to move into the CMS later.</p></div>
