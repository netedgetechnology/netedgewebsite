...
<section class="page-hero v11-page-hero sm58-page-hero batch68-page-hero">
  <div class="container sm58-hero-grid batch68-hero-grid">
    <div class="sm58-hero-copy">
      ...
      <h1>Dedicated Staffing</h1>
      <p>Dedicated Staffing services from Netedge Technology, designed for stable, secure and scalable technology operations.</p>
      <div class="sm58-hero-pills"><span>Dedicated</span><span>Server,</span><span>Flexible</span><span>Team</span></div>
    </div>
...
<div><span>✓</span>Cost-effective offshore staffing support</div></div></section>
    <section class="sm56-expertise"><div class="sm56-section-title center"><span class="section-label">Expertise</span><h2>Our Dedicated Staffing Expertise</h2><p>Professional service coverage designed around your business requirement and operational goals.</p></div><div class="sm56-card-grid batch68-card-grid"><article class="sm56-expert-card batch68-card">
          ...
          <h3>Dedicated technical staff for long-term requirements</h3>
          <p>Dedicated technical staff for long-term requirements with professional planning, execution and ongoing support.</p>
...
<article class="sm56-expert-card batch68-card">
          <div class="sm56-card-icon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M4 6h16v12H4V6Z"/><path d="M8 10h8M8 14h5M7 21h10M12 18v3"/></svg></div>
          <h3>Server, hosting, cloud</h3>
          <p>Server, hosting, cloud and support professionals with professional planning, execution and ongoing support.</p>
          <ul><li>Process-driven delivery</li><li>Security and reliability focus</li><li>Documentation and reporting</li></ul>
          <strong>Explore</strong>
        </article>
<article class="sm56-expert-card batch68-card">
          <div class="sm56-card-icon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M4 6h16v12H4V6Z"/><path d="M8 10h8M8 14h5M7 21h10M12 18v3"/></svg></div>
          <h3>Flexible staffing based on skill</h3>
          <p>Flexible staffing based on skill and workload with professional planning, execution and ongoing support.</p>
          <ul><li>Process-driven delivery</li><li>Security and reliability focus</li><li>Documentation and reporting</li></ul>
          <strong>Explore</strong>
        </article>
<article class="sm56-expert-card batch68-card">
          <div class="sm56-card-icon" aria-hidden="true"><svg viewBox="0 0 24 24"><path d="M4 6h16v12H4V6Z"/><path d="M8 10h8M8 14h5M7 21h10M12 18v3"/></svg></div>
          <h3>Team extension model for IT operations</h3>
          <p>Team extension model for IT operations with professional planning, execution and ongoing support.</p>
          <ul><li>Process-driven delivery</li><li>Security and reliability focus</li><li>Documentation and reporting</li></ul>
          <strong>Explore</strong>
        </article></div></section>
    <section class="content-cta-block"><div><h2>Need dedicated staffing support?</h2><p>Share your requirement and our team will review the right support model for your business.</p></div><a class="btn" href="<?= e(url('discuss-a-requirement')) ?>">Discuss A Requirement</a></section>
  </div>
</section>